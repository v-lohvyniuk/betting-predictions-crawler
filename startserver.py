...
if __name__ == "__main__":
    ...
    Scheduler().every_mins(10).execute(PredictionIntegrationService().get_matches_predictions).start()
    Scheduler().every_mins(14).execute(telegram_bot.send_new_predictions).start()
